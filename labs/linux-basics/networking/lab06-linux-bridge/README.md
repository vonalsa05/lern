...
1. Что такое Linux Bridge и на каком уровне модели OSI он работает?
2. Почему при создании veth-пары и перемещении одного конца в Network Namespace мы видим, что порт пропадает на хосте?
3. В чем разница между PVID (Port VLAN ID) и обычным тегированием VLAN на Linux Bridge?
